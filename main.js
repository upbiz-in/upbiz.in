    ...
    * ------------------------------------------------------ */
    const ssGradientText = function() {
        ...
        const updateTextHighlight = () => {
            ...
            // Animation starts when the top of the text block enters the viewport from the bottom.
            const animStart = viewportHeight;
            
            // Animation ends when the top of the text block reaches the vertical middle of the viewport.
            const animEnd = viewportHeight / 2;

            // Calculate the progress of the animation.
            // rect.top is the distance of the element's top from the viewport's top.
            let scrollProgress = (animStart - rect.top) / (animStart - animEnd);
